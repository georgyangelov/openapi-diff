...
public class OneOfDiffTest {
  ...
  private final String OPENAPI_DOC11 = "oneOf_diff_with_no_oneOf_1.yaml";
  private final String OPENAPI_DOC12 = "oneOf_diff_with_no_oneOf_2.yaml";
  ...
  @Test
  public void testOneOfSchemaWithSchemaWithoutOneOf() {
